...
getMeteors = () => {
  axios
      .get("https://api.nasa.gov/neo/rest/v1/feed?start_date=2022-09-15&end_date=2022-09-22&api_key=tZ6i2kQ4SmMPTBYb25nPI5odpFOoNrIsOAZ6yWgP")
      .then(response => {
  ...
  renderItem = ({item}) => {
    ...
    <View> <ImageBackground source={bg_img} style={styles.backgroundImage}>
      ...
      render(){
        ...
        var meteor_matriz = Object.keys(this.state.meteors).map(meteor_date =>{
          return this.state.meteors[meteor_date]
        })
        var meteors = [].concat.apply([], meteor_matriz)
